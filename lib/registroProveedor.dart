...
import 'api/RegisterProveedor.dart';

class RegistroProveedor extends StatelessWidget {
                      ...
                      child: RaisedButton(
                          ...
                          onPressed: () {
                            ...
                            if(_formKey.currentState.validate()) {
                              ...
                              RegisterProveedor(context, _nombreController.text, _apellidoPController.text,_apellidoMController.text,_marcaController.text,_telefonoController.text,_direccionController.text,_correoController.text,_contrasenaController.text);
                            }
